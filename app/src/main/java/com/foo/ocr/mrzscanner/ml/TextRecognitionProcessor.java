...
import com.foo.ocr.mrzscanner.mrzdecoder.MrzParser;
...
//        if (!lock)
    ...
    private Map<String, Long> findMostDuplicates(List<String> scanningText) {
    ...
    private String getLine1(Map<String, Long> map) {
